<template>
  <header role="banner" data-header class="cv-header bx--header" aria-label="label">
    ...
    <!-- Home Dropdown -->
    <div class="dropdown">
      <cv-header-global-action aria-label="Notifications" v-on:click="onHomeClicked">
          <Home20 />
    ...
    <span class="bx--header__section">Basic concepts -></span>
    </router-link>
